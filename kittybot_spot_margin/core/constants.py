...
PRICE_DELTA_BTC = 1  # То, на сколько уменьшается цена покупки для выполнения ордера в режиме MAKER

BUY_ORDER_LIFETIME = 90000  # Время жизни лимитного ордера на покупку в милисекундах
