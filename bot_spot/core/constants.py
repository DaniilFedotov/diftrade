...
BINANCE_TOKEN_S = os.getenv('BINANCE_TOKEN_SECOND')  # Токен для для API-binance
...
CLIENT_BINANCE_F = Spot(api_key=BINANCE_TOKEN_F, api_secret=BINANCE_KEY_F)  # Регистрируем клиента для API-binance
